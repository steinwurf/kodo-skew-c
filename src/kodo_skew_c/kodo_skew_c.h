...
typedef struct kodo_rlnc_encoder_factory* kodo_rlnc_encoder_factory_t;
typedef struct kodo_rlnc_decoder_factory* kodo_rlnc_decoder_factory_t;

/// Opaque pointer used for decoders, encoders
typedef struct kodo_rlnc_encoder* kodo_rlnc_encoder_t;
typedef struct kodo_rlnc_decoder* kodo_rlnc_decoder_t;
...
KODO_RLNC_API
void kodo_rlnc_encoder_factory_set_symbol_size(kodo_rlnc_encoder_factory_t factory, uint32_t symbol_size);
...
///         selected parameters.
KODO_RLNC_API
kodo_rlnc_decoder_factory_t kodo_rlnc_decoder_factory_construct(int32_t finite_field_id, uint32_t symbols, uint32_t symbol_size);
...
/// @param the symbol size in bytes
KODO_RLNC_API
void kodo_rlnc_decoder_factory_set_symbol_size(kodo_rlnc_decoder_factory_t factory, uint32_t symbol_size);
